...
function App() {
  ...
  function createInitialFlower() {
    new Flower({
      ...
      step: 4,
      colors: [
        '#FFEB3B', '#FFC107', '#FF9800', '#FBC02D', '#F9A825',
        '#F57F17', '#FFF176', '#FFB300', '#FFCC00', '#FFD54F',
        '#FFD600', '#FFC400', '#FFAB00', '#FF9100', '#FF6F00',
        '#FFF9C4', '#FFF59D', '#FFF176', '#FFEE58', '#FFEA00'
      ],
      alpha: 0.8,
      angle: rnd(PI),
